...
function MobileSwipeCard({
    ...
    const initials = trx.mustahiq_name.charAt(0).toUpperCase();
...
export default function Index({ transactions, mustahiqs }: Props) {
    ...
    const confirmDelete = () => {
        if (confirmDeleteId) {
            router.delete(route("zakat.penyaluran") + `/${confirmDeleteId}`, {
        ...
        <AppLayout title="Pengelola Zakat">
                            ...
                            <div className="flex items-center gap-1 p-1 bg-slate-100 rounded-xl w-fit">
                                {(
                                    ...
                                    >
                                        {jenisFilter === val && (
                                            <motion.div
                                                layoutId="activeJenisPenyaluran"
                        ...
                        {filteredData.length === 0 && (
                            <div className="flex flex-col items-center justify-center text-slate-400 py-8 bg-white rounded-2xl shadow-sm border border-slate-100 mt-2">
                                <div className="w-12 h-12 bg-slate-50 rounded-full flex items-center justify-center mb-3">
                                    <ArrowUpFromLine className="w-6 h-6 text-slate-300" />
                                </div>
            ...
            <div className="hidden md:contents">
                <PageHeader
                    ...
                    description="Pencatatan penyaluran Zakat Maal dan Zakat Fitrah kepada para Mustahiq."
                >
                ...
                <FilterBar
                    searchPlaceholder="Cari penyaluran..."
                    searchValue={search}
